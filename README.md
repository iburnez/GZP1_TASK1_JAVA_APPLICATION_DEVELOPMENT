...
#I feel like the biggest flaw of my project was being inconsistent with how I handled the time in appointment scheduling and it lead to a lot of custom methods for converting time from one form to another. MAKE SURE you can get LocalDateTime.Now() and convert it to UTC and a STRING and STRING to LDT and UTC. It will save you a lot of headache. 
